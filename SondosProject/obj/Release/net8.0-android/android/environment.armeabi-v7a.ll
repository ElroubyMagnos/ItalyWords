...
@dso_cache = dso_local local_unnamed_addr global [676 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 608153034, ; hash 0x243fadca, from name: libaot-SondosProject
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 645526868, ; hash 0x2679f554, from name: SondosProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 99
	...
	%struct.DSOCacheEntry {
		i64 1554719818, ; hash 0x5cab244a, from name: aot-SondosProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 240
	...
	%struct.DSOCacheEntry {
		i64 2814012326, ; hash 0xa7ba6ba6, from name: SondosProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 444
	...
	%struct.DSOCacheEntry {
		i64 3728200304, ; hash 0xde37d270, from name: libaot-SondosProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 588
	...
	%struct.DSOCacheEntry {
		i64 4033320415, ; hash 0xf06795df, from name: aot-SondosProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 636
