...
@dso_cache = dso_local local_unnamed_addr global [676 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.107_name, ; name: libaot-System.Transactions.Local.dll.so
		ptr null; void* handle (0x0)
	}, ; 17
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1491497854277090392, ; hash 0x14b2dd656b717c58, from name: libaot-SondosProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 49
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.95_name, ; name: libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 90
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3462228845992863301, ; hash 0x300c4ecab083e645, from name: SondosProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 128
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.78_name, ; name: libaot-System.Diagnostics.Tracing.dll.so
		ptr null; void* handle (0x0)
	}, ; 150
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.84_name, ; name: libaot-System.Linq.Queryable.dll.so
		ptr null; void* handle (0x0)
	}, ; 219
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 13964261415198515349, ; hash 0xc1cb05c57399e095, from name: libaot-SondosProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 521
	...
	%struct.DSOCacheEntry {
		i64 14795893519467170985, ; hash 0xcd5592c392584ca9, from name: aot-SondosProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 554
	...
	%struct.DSOCacheEntry {
		i64 16644238553449170216, ; hash 0xe6fc36c787330528, from name: aot-SondosProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 612
	...
	%struct.DSOCacheEntry {
		i64 17284777002485194136, ; hash 0xefdfdd1ae6f89d98, from name: SondosProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SondosProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 633
...
@.env.3 = private unnamed_addr constant [37 x i8] c"78c36c1d-9ac6-4226-ac52-c9ecc84a81e4\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.sondosproject\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [28 x i8] c"libaot-SondosProject.dll.so\00", align 16
...
@.DSOCacheEntry.78_name = private unnamed_addr constant [41 x i8] c"libaot-System.Diagnostics.Tracing.dll.so\00", align 16
...
@.DSOCacheEntry.84_name = private unnamed_addr constant [36 x i8] c"libaot-System.Linq.Queryable.dll.so\00", align 16
...
@.DSOCacheEntry.95_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 16
...
@.DSOCacheEntry.107_name = private unnamed_addr constant [40 x i8] c"libaot-System.Transactions.Local.dll.so\00", align 16
